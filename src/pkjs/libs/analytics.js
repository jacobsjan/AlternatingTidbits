// Based on https://github.com/r-dent/pebble-analytics/
...
Analytics.prototype._trackGA = function(type, params) {
  ...
  + '&sr=' + watchInfo.platform
  + '&sd=' + watchInfo.model
  + '&ul=' + watchInfo.language;
...
Analytics.prototype.trackException = function (err) {
  this._trackGA('exception', {'exd': err.substring(0,150)});
};
